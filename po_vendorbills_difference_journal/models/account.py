    ...
    def invoice_line_move_line_get(self):
        ...
        for line in self.invoice_line_ids:
            ...
            move_line_dict = {
                ...
                'price': line.purchase_line_id.last_received_value if line.purchase_line_id.last_received_value \
...
#         purchase = self.invoice_line_ids[0].purchase_line_id.order_id
#         value_to_inv = sum([v['price'] if product_obj.browse(v['product_id']).type == 'product' else 0 for v in res])
#         diff = purchase.last_received_value - value_to_inv
...
#             'analytic_tag_ids': analytic_tag_ids
#         }
#         purchase.last_received_value = 0
#         return res
